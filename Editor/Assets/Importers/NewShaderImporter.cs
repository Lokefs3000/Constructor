...
{
    internal sealed class NewShaderImporter : IAssetImporter
    {
        public NewShaderImporter()
        {
        ...
        public bool Import(AssetPipeline pipeline, ProjectSubFilesystem filesystem, string fullFilePath, string outputFilePath, string localOutputFile)
        {
            ...
            NewShaderProcessor processor = new NewShaderProcessor();
            ...
            Editor.GlobalSingleton.AssetDatabase.AddEntry<ShaderAsset2>(new AssetDatabaseEntry(id, localInputFile, true));
            return false;
        ...
        public void Preload(string localFilePath, ProjectSubFilesystem filesystem, AssetPipeline pipeline)
        {
            ...
            {
                Editor.GlobalSingleton.AssetDatabase.AddEntry<ShaderAsset2>(new AssetDatabaseEntry(id, localFilePath, false));
                return;
            }
            ...
            Editor.GlobalSingleton.AssetDatabase.AddEntry<ShaderAsset2>(new AssetDatabaseEntry(id, localFilePath, true));
        }
