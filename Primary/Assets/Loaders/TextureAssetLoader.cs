...
namespace Primary.Assets.Loaders
{
        ...
        public void FactoryLoad(IAssetDefinition asset, IInternalAssetData assetData, string sourcePath, string localPath, BundleReader? bundleToReadFrom)
        {
            ...
            try
            {
                ...
                rhiSampler = device.CreateSampler(new RHISamplerDescription
                {
                    ...
                    MaxAnisotropy = samplerInfo.MaxAnisotropy == 0 ? 16 : (uint)samplerInfo.MaxAnisotropy,
                }, sourcePath);
    ...
    public record struct TextureSwizzle
    {
        ...
        public TextureSwizzle()
            => this = Default;
        public TextureSwizzle(TextureSwizzleChannel r, TextureSwizzleChannel g, TextureSwizzleChannel b, TextureSwizzleChannel a)
