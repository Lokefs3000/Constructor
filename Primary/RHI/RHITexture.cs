namespace Primary.RHI2
{
    ...
    public struct RHISwizzle
    {
        ...
        {
            Swizzle = (ushort)((((int)r) << SwizzleRAmount) | (((int)g) << SwizzleGAmount) | (((int)b) << SwizzleBAmount) | (((int)a) << SwizzleAAmount));
        }
        ...
        public static RHISwizzle RGBA = new RHISwizzle(RHISwizzleChannel.Red, RHISwizzleChannel.Green, RHISwizzleChannel.Blue, RHISwizzleChannel.Alpha);
