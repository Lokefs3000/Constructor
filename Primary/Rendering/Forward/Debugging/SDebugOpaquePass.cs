...
namespace Primary.Rendering.Forward.Debugging
{
    internal class SDebugOpaquePass
    {
        ...
        private unsafe void HandleRenderBatch(RasterCommandBuffer commandBuffer, RenderingManager manager, RenderBatcher batcher, ForwardRenderPath path, ShaderRenderBatch renderBatch, ref uint offsetInMatrixBuffer)
        {
