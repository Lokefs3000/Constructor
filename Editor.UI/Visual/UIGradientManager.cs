...
namespace Editor.UI.Visual
{
    public sealed class UIGradientManager
    {
        ...
        private Int2 _gradientTextureSize;
        ...
        internal UIGradientManager()
        {
            ...
            _gradientTextureSize = Int2.Zero;
        }
        ...
        internal void ComputeGradientLayouts()
        {
            if (_registeredGradients.Count > 0)
            {
                using (new ProfilingScope("GradientLayout"))
                {
                    ...
                    _gradientTextureSize = new Int2((int)availSize.X, (int)availSize.Y);
                }
            }
        }
        ...
        public Int2 GradientTextureSize => _gradientTextureSize;
