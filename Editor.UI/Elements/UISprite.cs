...
namespace Editor.UI.Elements
{
    ...
    public class UISprite : UIElement
    {
        ...
        #region Properties
        [StyleableProperty(nameof(_image), UIStateFlags.InvalidVisual)] public Sprite? Sprite { get => _image as Sprite; set => SetStyleProperty(value); }
