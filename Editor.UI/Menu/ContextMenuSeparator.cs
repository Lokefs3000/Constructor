...
namespace Editor.UI.Menu
{
    public sealed class ContextMenuSeparator : ContextMenuBase
    {
        ...
        {
            painter.DrawRect(new Boundaries(new Vector2(basePosition.X + 2.0f, basePosition.Y), new Vector2(basePosition.X + availRegion.X, basePosition.Y) + new Vector2(-2.0f, 2.0f)), UIPaint.FromColor(s_separatorColor));
        }
