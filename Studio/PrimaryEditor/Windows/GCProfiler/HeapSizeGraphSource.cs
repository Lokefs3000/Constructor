...
{
    internal sealed class HeapSizeGraphSource : IGraphSource<double>
    {
        private AverageAnalyser<double> _heapSizeAverage;

        internal HeapSizeGraphSource()
        {
        ...
        {
            _heapSizeAverage.Sample(GC.GetGCMemoryInfo().HeapSizeBytes, Time.DeltaTime);
        }
